...
function MyMealsDisplay({ image, title, url, r, g, b, id, setDeleted }) {
  ...
  async function deleteMeal(id) {
    const remove = { meal_plan: { recipe_id: id } };
    console.log(user.user.sub, "usersub", remove, "remove id ");
    const res = useFetch(
      "mealPlan",
      "DELETE",
      remove,
